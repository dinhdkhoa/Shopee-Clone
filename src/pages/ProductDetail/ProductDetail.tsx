  ...
  return (
    <div className='bg-gray-200 py-6'>
      <Helmet>
        ...
        <meta name='description' content={`Trang thông sản phẩm ${product.name} Shopee`} />
      </Helmet>
      <div className='container'>
            ...
            <div className='col-span-5'>
              ...
              >
                <img
                  src={activeImg}
                  alt={product.name}
                  //Fix EventBubble with pointer-events-none
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                ...
                {currentImages.slice(0, 5).map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => hoverImg(img)}>
                      <img
                        src={img}
                        alt={product.name}
        ...
        <div className='mt-8 bg-white p-4 shadow'>
          <div className='container'>
            <div className='rounded bg-gray-50 p-4 text-lg capitalize text-slate-700'>{t('describe')}</div>
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='uppercase text-gray-400'>{t('sameCate')}</div>
          {productsData && (
