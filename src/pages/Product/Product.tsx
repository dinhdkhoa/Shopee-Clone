    ...
    <Link to=''>
      <div className='overflow-hidden rounded-sm bg-white shadow  transition-transform duration-100 hover:translate-y-[-0.0625rem] hover:shadow-md'>
        <div className='relative w-full pt-[100%]'>
          <img
            src='https://api-ecom.duthanhduoc.com/images/b1c008a6-bb10-46a6-8caf-2b0e9ca4e175.jpg'
            alt='product'
        ...
        <div className='overflow-hidden p-2'>
          <div className='line-clamp-2 min-h-[2rem] text-xs'>
            [Mã TOPMAY giảm đến 25k đơn 150k] Áo thun Ridiculous Taupe Beast, vải Cotton 2 chiều 100% định lượng 250g
            khổ 2m2
          </div>
          <div className='mt-3 flex items-center'>
            <div className='max-w-[50%] truncate text-gray-500 line-through'>
              <span className='text-xs'>₫</span>
              <span className='text-sm'>289.000</span>
            </div>
            <div className='ml-1 truncate text-orange'>
              <span className='text-xs'>₫</span>
              <span className='text-sm'>152.000</span>
            </div>
          </div>
